...
export class CommonService {
  ...
  siderbarMenuIcon =
    '<i nz-icon="" nzType="menu" class="anticon anticon-menu" ng-reflect-type="menu"><svg viewBox="64 64 896 896" fill="currentColor" width="1em" height="1em" data-icon="menu" aria-hidden="true"><path d="M904 160H120c-4.4 0-8 3.6-8 8v64c0 4.4 3.6 8 8 8h784c4.4 0 8-3.6 8-8v-64c0-4.4-3.6-8-8-8zm0 624H120c-4.4 0-8 3.6-8 8v64c0 4.4 3.6 8 8 8h784c4.4 0 8-3.6 8-8v-64c0-4.4-3.6-8-8-8zm0-312H120c-4.4 0-8 3.6-8 8v64c0 4.4 3.6 8 8 8h784c4.4 0 8-3.6 8-8v-64c0-4.4-3.6-8-8-8z"></path></svg></i>';
